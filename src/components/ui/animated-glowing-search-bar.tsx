      ...
      >
        ...
        <div id="main" className="relative group">
          <input
            ...
            type="text"
            name="text"
            className="bg-background border border-input w-[301px] h-[56px] rounded-lg text-foreground px-[59px] text-lg focus:outline-none placeholder:text-muted-foreground"
          />
          <div
            id="input-mask"
